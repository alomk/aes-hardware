// ======================================================================
// RNG.v generated from TopDesign.cysch
// 04/30/2020 at 03:50
...
module CharLCD_v2_10_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("0affd082-ba15-4c53-881a-4556a5c564d1/ed092b9b-d398-4703-be89-cebf998501f6"),
...
// IDAC8_v2_0(Current=120, Data_Source=0, Hardware_Enable=false, IDAC_Range=4, IDAC_Speed=0, Initial_Value=120, Polarity=0, Strobe_Mode=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=IDAC8_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC8_1, CY_INSTANCE_SHORT_NAME=IDAC8_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP1, INSTANCE_NAME=IDAC8_1, )
module IDAC8_v2_0_1 (
    iOut,
    data,
    strobe,
...
module ADC_DelSig_v3_20_2 (
	...
	cy_clock_v1_0
		#(.id("08bc284e-428a-454e-9415-7a3a8b2f432a/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("08bc284e-428a-454e-9415-7a3a8b2f432a/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("3861003861.00386"),
		  .is_direct(0),
		  .is_digital(0))
		theACLK
		 (.clock_out(Net_250));
...
module UART_v2_50_3 (
	...
	cy_clock_v1_0
		#(.id("56b380ef-7b88-4ded-b5a6-e06688321b84/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
